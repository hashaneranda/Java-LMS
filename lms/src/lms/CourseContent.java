...
public class CourseContent extends javax.swing.JFrame {
    ...
    public CourseContent(String Course,String dept,int userId,String yr) throws IOException{
        super(Course);
        initComponents();
        
        deptN1.setDepartment(dept);
        deptN1.setUserID(userId);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        dispose();
         try{
            new CourseList(deptN1.getYear(), deptN1.getDepartment(), deptN1.getUserID()).setVisible(true);
